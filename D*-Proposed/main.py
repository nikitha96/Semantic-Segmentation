...
from ModelDataParallel import ModelDataParallel,CriterionDataParallel
...
def main(args):
    ...
    if (not args.state):
        if args.pretrainedEncoder:
            ...
            from model_imagenet import Model_Net as ModelNet_imagenet
            pretrainedEnc = torch.nn.DataParallel(ModelNet_imagenet(1000))
