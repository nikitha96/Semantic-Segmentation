...
class Encoder(nn.Module):
    def __init__(self):
        ...
        for x in range(0, 2):    #2 times
            self.layers.append(conv_module(128, 0.1, 2))
            self.layers.append(conv_module(128, 0.1, 4))
            self.layers.append(conv_module(128, 0.1, 8))
            self.layers.append(conv_module(128, 0.1, 16))
